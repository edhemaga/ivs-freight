...
export function getExtendedDriverTableColumnsDefinition() {
  return [
    ...
    {
      ngTemplate: 'phoneTemplate',
      title: 'Phone',
      field: 'additionalData.phone',
      name: 'Phone',
      hidden: false,
      width: 117,
      filter: '',
    ...
    },
    {
      ngTemplate: 'defaultTemplate',
      title: 'Address',
      field: 'additionalData.address.address',
      name: 'Address',
      hidden: true,
      width: 50,
      filter: '',
    ...
    },
    {
      ngTemplate: 'defaultTemplate',
      title: 'DOB',
      field: 'additionalData.birthDateShort',
      name: 'DOB',
      hidden: false,
      width: 83,
      filter: '',
    ...
    },
    {
      ngTemplate: 'defaultTemplate',
      title: 'Hired',
      field: 'workData[0].startDateShort',
      name: 'Hired',
      isComputed: false,
      hidden: false,
      width: 76,
    ...
    },
    {
      ...
      title: 'State',
      field: 'licenseData[0].state.value',
      name: 'State',
      hidden: false,
      width: 60,
      filter: '',
    ...
    },
    {
      ngTemplate: 'defaultTemplate',
      title: 'Bank',
      field: 'additionalData.bankData.bankName',
      name: 'Bank',
      hidden: true,
      width: 50,
      filter: '',
    ...
    },
    {
      ngTemplate: 'defaultTemplate',
      title: 'Account',
      field: 'additionalData.bankData.accountNumber',
      name: 'Account',
      hidden: true,
      width: 50,
      filter: '',
    ...
    },
    {
      ngTemplate: 'defaultTemplate',
      title: 'Routing',
      field: 'additionalData.bankData.routingNumber',
      name: 'Routing',
      hidden: true,
      width: 50,
      filter: '',
