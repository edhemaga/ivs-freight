...
export class SharedService {
                    ...
                    control.valueChanges.subscribe(() => {
                        if (
                            ...
                            switch (data[key1]) {
                                ...
                                case 'capitalize':
                                    const firstLetter = control.value.slice(
                                        0,
                                        1
                                    );
                                    const newValue =
    ...
    updateOwner(data: any, id: number) {
        return this.http
            .put(environment.API_ENDPOINT + `owner/${id}`, data)
            .pipe(
                tap(() => {
    ...
    addMaintenanceGlobal(data: any) {
        return this.http
            .post(environment.API_ENDPOINT + 'maintenance', data)
            .pipe(
                tap(() => {
    ...
    getMaintenanceList() {
        return this.http.get(
            environment.API_ENDPOINT +
                `maintenance/list/all/1/${environment.perPage}`
        );
    }

    editMaintennace(id: number) {
        return this.http.get(
            environment.API_ENDPOINT + `maintenance/${id}/all`
        );
    }

    addRepairShop(data: any) {
        return this.http
            .post(environment.API_ENDPOINT + 'repairshop', data)
            .pipe(
                tap(() => {
    ...
    getRepairShops() {
        return this.http.get(
            environment.API_ENDPOINT +
                `repairshop/list/all/1/${environment.perPage}`
        );
    }
    ...
    createRepairShopReview(data: any) {
        return this.http.post(
            environment.API_ENDPOINT + `repairshop/review`,
            data
        );
    }
    ...
    getRepairShopReviewList(repairShopId: number) {
        return this.http.get(
            environment.API_ENDPOINT +
                `repairshop/review/list/${repairShopId}/1/100`
        );
    }
    ...
    updateRepairShopReview(data: any, repairShopReviewId: number) {
        return this.http.put(
            environment.API_ENDPOINT +
                `repairshop/review/${repairShopReviewId}`,
            data
        );
    }
    ...
    updateCompany(data: any, id: number) {
        return this.http
            .put(environment.API_ENDPOINT + `company/${id}`, data)
            .pipe(
                tap(() => {
    ...
    deleteDivisionCompany(id: number) {
        return this.http
            .delete(environment.API_ENDPOINT + `company/${id}`)
            .pipe(
                tap(() => {
                    this.editOfficeFactoringSubject.next();
                })
