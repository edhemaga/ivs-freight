...
export class DashboardTopDriverComponent implements OnInit, OnDestroy {
      ...
      dataProperties: [
         {
            defaultConfig: {
               ...
               data: [
                  ...
                  120000, 70000, 50000, 28000, 80000, 120000, 70000, 50000,
                  28000, 80000, 120000, 70000, 50000, 28000, 80000, 120000,
                  70000, 50000,
               ],
               yAxisID: 'y-axis-0',
         ...
         },
         {
            defaultConfig: {
               ...
               data: [
                  ...
                  120000, 90000, 60000, 50000, 100000, 120000, 90000, 60000,
                  50000, 100000, 120000, 90000, 60000, 50000, 100000, 120000,
                  90000, 60000, 50000, 100000, 120000, 90000, 60000, 50000,
                  100000, 120000,
               ],
               yAxisID: 'y-axis-0',
   ...
   updateBarChart(selectedStates: any) {
      let dataSend = [
         ...
         95000, 47000, 80000, 120000, 90000, 60000, 100000, 95000, 47000, 80000,
         120000, 90000, 60000, 50000, 100000, 120000,
      ];
