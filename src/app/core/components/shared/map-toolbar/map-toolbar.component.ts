        ...
        this.mapForm.valueChanges
            ...
            .subscribe((formChanges) => {
                if (
                    ...
                    formChanges.distanceUnit !=
                        this.activeTableData.distanceUnit ||
                    formChanges.addressType !=
                        this.activeTableData.addressType ||
            ...
            .subscribe((formChanges) => {
                ...
                if (this.routeToEdit.id) {
                    originalValues = {
                        ...
                        truckId: this.routeToEdit.truckId
                            ? this.routeToEdit.truckId
                            : '',
                        ...
                        fuelMpg: this.routeToEdit.mpg
                            ? this.routeToEdit.mpg
                            : null,
