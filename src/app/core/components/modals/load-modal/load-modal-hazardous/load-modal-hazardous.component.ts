...
export class LoadModalHazardousComponent {
  public hazardous_materials_section = [
    {
      ...
      subType: [
        ...
        },
        {
          type: '(2)',
          title:
            'In a compartment within a multi-compartmented cargo tank subject to the restrictions in § 173.33 of this subchapter; or',
        },
        {
          type: '(3)',
          title:
            'In a portable tank loaded in a transport vehicle or freight container.',
        },
      ],
    },
    {
      type: '(b)',
      title:
        'When a transport vehicle is to be transported by vessel, other than a ferry vessel, hazardous materials on or within that vehicle must be stowed and segregated in accordance with § 176.83(b) of this subchapter.',
      subType: [],
    },
    {
      type: '(c)',
      title:
        'In addition to the provisions of paragraph (d) of this section and except as provided in § 173.12(e) of this subchapter, cyanides, cyanide mixtures or solutions may not be stored, loaded and transported with acids if a mixture of the materials would generate hydrogen cyanide; Division 4.2 materials may not be stored, loaded and transported with Class 8 liquids; and Division 6.1 Packing Group I, Hazard Zone A material may not be stored, loaded and transported with Class 3 material, Class 8 liquids, and Division 4.1, 4.2, 4.3, 5.1 or 5.2 materials.',
      subType: [],
    },
    {
      type: '(d)',
      title:
        'Except as otherwise provided in this subchapter, hazardous materials must be stored, loaded or transported in accordance with the following table and other provisions of this section:',
      subType: [],
    },
  ];
  ...
  public segregation_section_2 = [
    ...
    },
    {
      ...
      title:
        'The “*”in the Table indicates that segregation among different Class 1 (explosive) materials is governed by the compatibility table in paragraph (f) of this section. See right table.',
    },
    {
      type: '(5)',
      tableContext: 'ic_hazardous-a-field.svg',
      title:
        'The note “A” in the third column of the Table means that, notwithstanding the requirements of the letter “X” , ammonium nitrate (UN 1942) and ammonium nitrate fertilizer may be loaded or stored with Division 1.1 (explosive) or Division 1.5 materials.',
    },
    {
      type: '(6)',
      tableContext: null,
  ...
  public segregation_section_3 = [
    {
      type: '(d)',
      title:
        'Class 1 (explosive) materials shall not be loaded, transported, or stored together, except as provided in this section, and in accordance with the following table:',
      subType: [],
    },
  ];
  ...
  public additional_note_section = [
    {
      ...
      title:
        'P Packages with POISON or POISON INHALATION HAZARD labels, or a POISON label displaying “PG III,” or “PG III” marked next to a POISON label may not be transported with foodstuffs, feed or any other edible material, intended for humans or animals. For exceptions see 49 CFR §177.841(e).',
      subType: [],
    },
  ];
  ...
  public compatibility_section_1 = [
    {
      type: '(e)',
      title:
        'Instructions for using the compatibility table for Class 1 (explosive) materials are as follows:',
      subType: [],
    },
  ];
  ...
  public compatibility_section_2 = [
    ...
    },
    {
      ...
      tableContextText: '5',
      title:
        '"5" means Division 1.4S fireworks may not be loaded on the same transport vehicle with Division 1.1 or 1.2 (explosive) materials.',
    },
    {
      type: '(VI)',
      tableContextSvg: '',
    ...
    },
    {
      ...
      tableContextText: '',
      title:
        'Except as provided in paragraph (i) of this section, explosives of the same compatibility group but of different divisions may be transported together provided that the whole shipment is transported as though its entire contents were of the lower numerical division (i.e., Division 1.1 being lower than Division 1.2). For example, a mixed shipment of Division 1.2 (explosive) materials and Division 1.4 (explosive) materials, both of compatibility group D, must be transported as Division 1.2 (explosive) materials.',
    },
    {
      type: '(i)',
      tableContextSvg: '',
      tableContextText: '',
      title:
        'When Division 1.5 materials, compatibility group D, are transported in the same freight container as Division 1.2 (explosive)  materials, compatibility group D, the shipment must be transported as Division 1.1 (explosive) materials, compatibility group D.',
    },
  ];
