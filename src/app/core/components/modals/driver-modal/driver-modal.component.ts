            ...
            next: (data: GetDriverModalResponse) => {
               ...
               if (['Solo', 'Combined'].includes(this.fleetType)) {
                  this.driverForm
                     .get('soloEmptyMile')
                     .patchValue(
                        data.solo?.emptyMile ? data.solo.emptyMile : null,
                        {
                           emitEvent: false,
                        }
                     );
                  ...
                  this.driverForm
                     .get('soloLoadedMile')
                     .patchValue(
                        data.solo?.loadedMile ? data.solo.loadedMile : null,
                        {
                           emitEvent: false,
                        }
                     );
               ...
               if (['Team', 'Combined'].includes(this.fleetType)) {
                  this.driverForm
                     .get('teamEmptyMile')
                     .patchValue(
                        data.team?.emptyMile ? data.team.emptyMile : null,
                        {
                           emitEvent: false,
                        }
                     );
                  ...
                  this.driverForm
                     .get('teamLoadedMile')
                     .patchValue(
                        data.team?.loadedMile ? data.team.loadedMile : null,
                        {
                           emitEvent: false,
                        }
                     );
                  ...
                  for (
                     ...
                     this.offDutyLocations.push(
                        this.createOffDutyLocation({
                           ...
                           addressUnit:
                              res.offDutyLocations[index].address.addressUnit,
