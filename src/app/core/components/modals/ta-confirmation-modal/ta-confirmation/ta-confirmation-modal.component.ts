...
@Component({
    selector: 'app-ta-confirmation-modal',
    templateUrl: './ta-confirmation-modal.component.html',
    styleUrls: ['./ta-confirmation-modal.component.scss'],
    standalone: true,
    imports: [
        // modules
        CommonModule,
...
export class TaConfirmationModalComponent implements OnInit {
