      ...
      services: [
        {
          id: 1,
          name: 'Truck',
          svg: 'assets/svg/common/repair-services/repair-serivces-details/ic_truck.svg',
          isUsefulService: true,
        },
        {
          id: 2,
          name: 'Trailer',
          svg: 'assets/svg/common/repair-services/repair-serivces-details/ic_trailer.svg',
          isUsefulService: true,
        },
        {
          id: 3,
          name: 'Mobile',
          svg: 'assets/svg/common/repair-services/repair-serivces-details/ic_mobile.svg',
          isUsefulService: false,
        },
        {
          id: 4,
          name: 'Shop',
          svg: 'assets/svg/common/repair-services/repair-serivces-details/ic_shop.svg',
          isUsefulService: true,
        },
        {
          id: 5,
          name: 'Towing',
          svg: 'assets/svg/common/repair-services/repair-serivces-details/ic_towing.svg',
          isUsefulService: true,
        },
        {
          id: 6,
          name: 'Parts',
          svg: 'assets/svg/common/repair-services/repair-serivces-details/ic_parts.svg',
          isUsefulService: true,
        },
        {
          id: 7,
          name: 'Tire',
          svg: 'assets/svg/common/repair-services/repair-serivces-details/ic_tire.svg',
          isUsefulService: true,
        },
        {
          id: 9,
          name: 'Dealer',
          svg: 'assets/svg/common/repair-services/repair-serivces-details/ic_dealer.svg',
          isUsefulService: false,
        },
      ],
      rent: '',
