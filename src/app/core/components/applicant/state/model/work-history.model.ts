...
export class WorkHistory {
    ...
    constructor(workHistory?: WorkHistory) {
        ...
        this.fromDate = workHistory?.fromDate
        ...
        this.jobDescription = workHistory?.jobDescription
            ...
            : '';
        this.isDeleted = workHistory?.isDeleted
            ? workHistory?.isDeleted
            : false;
        this.isCompleted = workHistory?.isCompleted
            ? workHistory?.isCompleted
            : false;
        this.isExpanded = workHistory?.isExpanded
            ? workHistory?.isExpanded
            : false;
    }
}
