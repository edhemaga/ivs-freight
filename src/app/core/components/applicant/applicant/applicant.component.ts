        ...
        if (this.selectedMode === SelectedMode.REVIEW) {
          this.isStepReviewedArray = this.isStepReviewedArray.map(
            (item, index) => {
              ...
              if (index === 8) {
                const driverRightsReview = res?.driverRight?.reviewed;

                return {
                  ...item,
                  isReviewed: driverRightsReview ? true : false,
                };
              }
              ...
              if (index === 9) {
                ...
                return {
                  ...item,
                  isReviewed: disclosureAndReleaseReview ? true : false,
                };
              }

              if (index === 10) {
                const autorizationReview = res?.authorization?.reviewed;

                return {
                  ...item,
                  isReviewed: autorizationReview ? true : false,
                };
              }
