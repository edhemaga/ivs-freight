export class SharedSvgRoutes {
    static DATE_ICON = 'assets/svg/common/date.svg';
    static CLOSE_ICON = 'assets/svg/applicant/invalid-review-x.svg';
    static STAR_ICON = 'assets/svg/common/ic_star.svg';
    static PHONE_ICON = 'assets/svg/common/ic_phone.svg';
    static X_ICON = 'assets/svg/applicant/cancel.svg';
    ...
    static REORDER_COLUMN_ICON: string =
        'assets/svg/common/ic_reorder_column.svg';
    ...
    static LOAD_SHIPPER_CONTACT =
        'assets/svg/common/load/ic_load_shipper_contact_avatar.svg';
}
