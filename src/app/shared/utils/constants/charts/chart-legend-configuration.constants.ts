...
export class ChartLegendConfiguration {
    ...
    public static invoiceChartLegendConfiguration =
        (data: BrokerPaidInvoiceChartResponse): ChartLegendProperty[] =>
            [
                {
                    name: 'Revenue',
    ...
    public static fuelExpensesLegend =
        (data: FuelStopExpensesResponse): ChartLegendProperty[] =>
            [
                {
                    name: 'Gallon',
                    value: data?.gallon || 0,
    ...
    public static trailerFuelConsumptionConfiguration =
        (data: TrailerFuelConsumptionChartResponse): ChartLegendProperty[] =>
            [
                {
                    name: 'Gallon',
    ...
    public static truckFuelConsumptionConfiguration =
        (data: TruckFuelConsumptionChartResponse): ChartLegendProperty[] =>
            [
                {
    ...
    public static truckRevenueConfiguration =
        (data: TruckRevenueChartResponse): ChartLegendProperty[] =>
            [
                {
                    name: 'Miles',
                    value: data?.miles || 0,
    ...
    public static truckExpensesConfiguration =
        (data: TruckExpensesChartResponse): ChartLegendProperty[] =>
            [
                {
                    name: 'Fuel Cost',
    ...
    public static brokerPaymentHistory =
        (data: IBrokerPaymentHistoryChart): ChartLegendProperty[] =>
            [
                {
                    name: 'Avg. Pay Period',
    ...
    public static shipperAverageWaitingTimeConfiguration =
        (data: ShipperAverageWaitingTimeResponse): ChartLegendProperty[] =>
            [
                {
