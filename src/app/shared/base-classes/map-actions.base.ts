...
export abstract class MapActionsBase {
    protected destroy$: Subject<void>;

    protected abstract mapListSortColumns: SortColumn[];
    ...
    protected abstract getClusters(
        isClusterPagination?: boolean,
        selectedMarkerId?: number
    ): void;
    protected abstract getMapList(): void;
    protected abstract getMarkerById(): void;
