...
@Component({
    selector: 'app-ta-carrier-search',
    standalone: true,
    imports: [
        CommonModule,
    ...
    templateUrl: './ta-carrier-search.component.html',
    styleUrls: ['./ta-carrier-search.component.scss'],
})
export class TaCarrierSearchComponent implements OnInit, OnChanges, OnDestroy {
