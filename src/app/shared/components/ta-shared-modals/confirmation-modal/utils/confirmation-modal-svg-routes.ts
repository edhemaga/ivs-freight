export class ConfirmationModalSvgRoutes {
    ...
    static confirmationInspectionSvg = '/assets/svg/common/inspection.svg';
    static confirmationTitle = '/assets/svg/common/title.svg';
    static confirmationVoidSvg = '/assets/svg/void.svg';
    static confirmationNoteOrderSvg = '/assets/svg/common/ic_note_order.svg';
