...
@Component({
    selector: 'app-ta-truckassist-table-head',
    templateUrl: './ta-truckassist-table-head.component.html',
    styleUrls: ['./ta-truckassist-table-head.component.scss'],
    standalone: true,
    imports: [
        CommonModule,
        FormsModule,
...
export class TaTruckassistTableHeadComponent
