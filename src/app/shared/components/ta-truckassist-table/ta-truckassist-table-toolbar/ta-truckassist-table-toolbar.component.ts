...
import { ConfirmationResetService } from '../../../../core/components/modals/confirmation-modal/state/state/services/confirmation-reset.service';
...
import { LoadCardsModalComponent } from '../../../../core/components/modals/cards-modal/load-cards-modal/load-cards-modal.component';
import { ConfirmationModalResetComponent } from '../../../../core/components/modals/confirmation-modal/confirmation-modal-reset/confirmation-modal-reset.component';
...
import { optionsPopupContent } from '../../../../core/components/shared/model/toolbar';

@Titles()
@Component({
    selector: 'app-ta-truckassist-table-toolbar',
    templateUrl: './ta-truckassist-table-toolbar.component.html',
    styleUrls: ['./ta-truckassist-table-toolbar.component.scss'],
    standalone: true,
    imports: [
        // modules
        CommonModule,
...
export class TaTruckassistTableToolbarComponent
