...
// strategy
import { TableStrategy } from './strategy/table_strategy';
...
@Titles()
@Component({
    selector: 'app-ta-truckassist-table-body',
    templateUrl: './ta-truckassist-table-body.component.html',
    styleUrls: ['./ta-truckassist-table-body.component.scss'],
...
export class TaTruckassistTableBodyComponent
