...
function factory(dir: TaCalendarDatesMainComponent) {
...
@Component({
    selector: 'app-ta-calendar-dates-main',
    templateUrl: './ta-calendar-dates-main.component.html',
    styleUrls: ['./ta-calendar-dates-main.component.scss'],
    standalone: true,
    imports: [
        CommonModule,
        FormsModule,
    ...
    providers: [
        {
            ...
            useFactory: factory,
            deps: [forwardRef(() => TaCalendarDatesMainComponent)],
        },
    ],
})
export class TaCalendarDatesMainComponent
