...
// constants
import { RANGE, STARTING_YEAR } from './strategys/calendar_strategy';

// components
import { TaCalendarDatesMainComponent } from '../ta-calendar-dates-main/ta-calendar-dates-main.component';
