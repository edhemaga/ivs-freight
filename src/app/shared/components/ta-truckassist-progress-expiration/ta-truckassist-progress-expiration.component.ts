...
@Component({
    selector: 'app-ta-truckassist-progress-expiration',
    templateUrl: './ta-truckassist-progress-expiration.component.html',
    styleUrls: ['./ta-truckassist-progress-expiration.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    standalone: true,
    imports: [CommonModule, FormsModule, ReactiveFormsModule],
})
export class TaTruckassistProgressExpirationComponent implements OnInit {
