...
@Component({
    ...
    templateUrl: './fuel-card-modal.component.html',
    styleUrls: ['./fuel-card-modal.component.scss'],
    standalone: true,
...
export class FuelCardModalComponent implements OnInit, OnDestroy {
    ...
    private resetToDefault(): void {
        const cardsData = {
            numberOfRows: FuelCardsModalConfig.rows,
            checked: true,
            front_side:
                this.tabSelected === TableStringEnum.ACTIVE
                    ? FuelCardsModalConfig.displayRowsFrontActive
                    : FuelCardsModalConfig.displayRowsFrontInactive,
            back_side:
                this.tabSelected === TableStringEnum.ACTIVE
                    ? FuelCardsModalConfig.displayRowsBackActive
                    : FuelCardsModalConfig.displayRowsBackInactive,
        };
