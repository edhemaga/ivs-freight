...
// config
import { Step6Config } from '@pages/applicant/pages/applicant-application/components/step6/configs/step6.config';
...
export class Step6Component implements OnInit, OnDestroy, AfterContentChecked {
    ...
    }[] = ApplicantApplicationConstants.displayRadioRequiredNoteArrayStep6;
    ...
    public questions: ApplicantQuestion[] =
        ApplicantApplicationConstants.questionsStep6;
    ...
    }[] = ApplicantApplicationConstants.openAnnotationArrayStep6;
    ...
    get driverForCompanyBeforeExplainInputConfig(): ITaInput {
        return Step6Config.getDriverForCompanyBeforeExplainInputConfig({
            selectedMode: this.selectedMode,
            stepFeedbackValues: this.stepFeedbackValues,
        });
    }

    get driverForCompanyToExplainInputConfig(): ITaInput {
        return Step6Config.getDriverForCompanyToExplainInputConfig({
            selectedMode: this.selectedMode,
            stepFeedbackValues: this.stepFeedbackValues,
        });
    }

    get isUnableToPreformJobInputConfig(): ITaInput {
        return Step6Config.getIsUnableToPreformJobInputConfig({
            selectedMode: this.selectedMode,
            stepFeedbackValues: this.stepFeedbackValues,
        });
    }

    get emergencyNameInputConfig(): ITaInput {
        return Step6Config.getEmergencyNameInputConfig();
    }

    get phoneInputConfig(): ITaInput {
        return Step6Config.getPhoneInputConfig();
    }

    get relationshipInputConfig(): ITaInput {
        return Step6Config.getRelationshipInputConfig();
    }
