...
import { selectActiveModalTabs } from '@pages/trailer/pages/trailer-card-modal/state/trailer-card-modal.selectors';
...
@Component({
    selector: 'app-trailer-card-modal',
    templateUrl: './trailer-card-modal.component.html',
    styleUrls: ['./trailer-card-modal.component.scss'],
    standalone: true,
...
export class TrailerCardModalComponent implements OnInit, OnDestroy {
    ...
    public cardsAllData: CardRows[] = TrailerCardsModalData.allDataLoad;
    ...
    constructor(
        ...
        private modalService: TrailerCardsModalService,
        //Store
        private store: Store,
