export class LoadStoreConstants {
    ...
    public static ACTION_LOAD_PAGE_LIST_SUCCESS = `${this.COMPONENT_NAME_KEY} ACTION_LOAD_PAGE_LIST_SUCCESS`;
    ...
    static ACTION_UPDATE_LOAD_STATUS_REGULAR = `${this.COMPONENT_NAME_KEY} ACTION_UPDATE_LOAD_STATUS_REGULAR`;
    ...
    public static ACTION_ON_COMMENT_ADD_ERROR = `${this.COMPONENT_NAME_KEY} ACTION_ON_COMMENT_ADD_ERROR`;

    public static ACTION_ON_COMMENT_DELETE = `${this.COMPONENT_NAME_KEY} ACTION_ON_COMMENT_DELETE`;
    public static ACTION_ON_COMMENT_DELETE_SUCCESS = `${this.COMPONENT_NAME_KEY} ACTION_ON_COMMENT_DELETE_SUCCESS`;
    public static ACTION_ON_COMMENT_DELETE_ERROR = `${this.COMPONENT_NAME_KEY} ACTION_ON_COMMENT_DELETE_ERROR`;
