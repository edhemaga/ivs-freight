    ...
    implements OnInit, OnChanges, OnDestroy
{
    ...
    public stopItemHeaders: string[] = LoadStopItems.STOP_ITEM_HEADERS;
    ...
    public handleInputSelect(
        ...
        if (dropdownListItem) {
            switch (action) {
                case LoadModalStopItemsStringEnum.QUANTITY:
                    this.selectedQuantity[stopItemsRowId] = dropdownListItem;

                    break;
                case LoadModalStopItemsStringEnum.STACK:
                    this.selectedStack[stopItemsRowId] = dropdownListItem;

                    break;
                case LoadModalStopItemsStringEnum.SECURE:
    ...
    public getStopItems(): UntypedFormArray {
        return this.stopItemsForm.get(
            LoadModalStopItemsStringEnum.STOP_ITEMS
        ) as UntypedFormArray;
    }
