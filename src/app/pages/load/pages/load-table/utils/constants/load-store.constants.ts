export class LoadStoreConstants {
    ...
    static ACTION_SELECT_LOAD = `${this.COMPONENT_NAME_KEY}  ACTION_SELECT_LOAD`;

    static ACTION_TOGGLE_MAP = `${this.COMPONENT_NAME_KEY}  ACTION_TOGGLE_MAP`;
    static ACTION_GET_MINIMAL_LIST = `${this.COMPONENT_NAME_KEY}  ACTION_GET_MINIMAL_LIST`;

    static ACTION_SET_MINIMAL_LIST = `${this.COMPONENT_NAME_KEY}  ACTION_SET_MINIMAL_LIST`;
    static ACTION_SET_MINIMAL_LIST_ERROR = `${this.COMPONENT_NAME_KEY}  ACTION_SET_MINIMAL_LIST_ERROR`;
}
