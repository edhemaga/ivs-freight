...
// Store
import { OwnerCardDataStore } from '@pages/owner/pages/owner-card-modal/state/owner-card-modal.store';
...
export class OwnerCardsModalService {
    constructor(private ownerStore: OwnerCardDataStore) {}
