...
export class ApplicantService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public apiApplicantCdlPost(cdlDenied?: boolean, cdlDeniedExplanation?: string, applicantId?: number, licences?: Array<CreateApplicantCdlCommand>, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext}): Observable<CreateResponse>;
    public apiApplicantCdlPost(cdlDenied?: boolean, cdlDeniedExplanation?: string, applicantId?: number, licences?: Array<CreateApplicantCdlCommand>, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext}): Observable<HttpResponse<CreateResponse>>;
    public apiApplicantCdlPost(cdlDenied?: boolean, cdlDeniedExplanation?: string, applicantId?: number, licences?: Array<CreateApplicantCdlCommand>, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext}): Observable<HttpEvent<CreateResponse>>;
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public apiApplicantCdlPut(cdlDenied?: boolean, cdlDeniedExplanation?: string, applicantId?: number, licences?: Array<UpdateApplicantCdlCommand>, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext}): Observable<object>;
    public apiApplicantCdlPut(cdlDenied?: boolean, cdlDeniedExplanation?: string, applicantId?: number, licences?: Array<UpdateApplicantCdlCommand>, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext}): Observable<HttpResponse<object>>;
    public apiApplicantCdlPut(cdlDenied?: boolean, cdlDeniedExplanation?: string, applicantId?: number, licences?: Array<UpdateApplicantCdlCommand>, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext}): Observable<HttpEvent<object>>;
