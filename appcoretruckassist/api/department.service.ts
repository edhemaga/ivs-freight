...
// @ts-ignore
import { DepartmentFilterResponse } from '../model/departmentFilterResponse';
// @ts-ignore
    ...
    public apiDepartmentFilterGet(isGeneral?: boolean, isBroker?: boolean, isShipper?: boolean, isCompany?: boolean, isCompanyContact?: boolean, isCompanyUser?: boolean, isCompanyOffice?: boolean, isToDo?: boolean, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext}): Observable<any> {
        ...
        if (isGeneral !== undefined && isGeneral !== null) {
          localVarQueryParameters = this.addToHttpParams(localVarQueryParameters,
            <any>isGeneral, 'IsGeneral');
        }
        if (isBroker !== undefined && isBroker !== null) {
          localVarQueryParameters = this.addToHttpParams(localVarQueryParameters,
            <any>isBroker, 'IsBroker');
        }
        if (isShipper !== undefined && isShipper !== null) {
          localVarQueryParameters = this.addToHttpParams(localVarQueryParameters,
            <any>isShipper, 'IsShipper');
        }
        if (isCompany !== undefined && isCompany !== null) {
          localVarQueryParameters = this.addToHttpParams(localVarQueryParameters,
            <any>isCompany, 'IsCompany');
        }
        if (isCompanyContact !== undefined && isCompanyContact !== null) {
          localVarQueryParameters = this.addToHttpParams(localVarQueryParameters,
            <any>isCompanyContact, 'IsCompanyContact');
        }
        if (isCompanyUser !== undefined && isCompanyUser !== null) {
          localVarQueryParameters = this.addToHttpParams(localVarQueryParameters,
            <any>isCompanyUser, 'IsCompanyUser');
        }
        if (isCompanyOffice !== undefined && isCompanyOffice !== null) {
          localVarQueryParameters = this.addToHttpParams(localVarQueryParameters,
            <any>isCompanyOffice, 'IsCompanyOffice');
        }
        ...
        let localVarPath = `/api/department/filter`;
        return this.httpClient.request<Array<DepartmentFilterResponse>>('get', `${this.configuration.basePath}${localVarPath}`,
            {
